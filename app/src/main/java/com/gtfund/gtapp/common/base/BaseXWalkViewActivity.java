...
import com.gtfund.gtapp.common.interfaces.ActivityPresenter;
import com.gtfund.gtapp.common.interfaces.OnBottomDragListener;
import com.gtfund.gtapp.common.manager.SystemBarTintManager;
import com.gtfund.gtapp.common.manager.ThreadManager;
...
public abstract class BaseXWalkViewActivity extends XWalkActivity implements ActivityPresenter {

    private static final String TAG = "BaseXWalkViewActivity";

    /**
     * 该Activity实例，命名为context是因为大部分方法都只需要context，写成context使用更方便
     * @warn 不能在子类中创建
     */
    protected BaseXWalkViewActivity context = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = (BaseXWalkViewActivity) getActivity();
        isAlive = true;
