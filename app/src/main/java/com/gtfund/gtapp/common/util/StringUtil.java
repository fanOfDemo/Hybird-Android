...
public class StringUtil {
    ...
    public static boolean isNumberOrAlpha(String s) {
        if (s == null) {
            android.util.Log.e(TAG, "isNumberOrAlpha  s == null >> return false;");
            return false;
        }
    ...
    public static boolean isIDCard(String idCard) {
        ...
        idCard = get(idCard);
        if (idCard.length() == 15) {
            android.util.Log.w(TAG, "isIDCard idCard.length() == 15 old IDCard");
    ...
    public static String getCorrectUrl(String url) {
        android.util.Log.i(TAG, "getCorrectUrl : \n" + url);
        if (isEmpty(url, true)) {
            return "";
        }
...
//		}
    ...
    public static String getPrice(String price, int formatType) {
        ...
        android.util.Log.i(TAG, "getPrice  <<<<<<<<<<<<<<<<<< correctPrice =  " + correctPrice);
