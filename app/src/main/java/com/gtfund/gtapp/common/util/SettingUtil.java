...
public final class SettingUtil {
    ...
    public static void putAllBoolean(boolean[] values){
        ...
        SharedPreferences.Editor editor = context.getSharedPreferences(APP_SETTING, Context.MODE_PRIVATE).edit();
        editor.clear();
     ...
     * HTTPS 正式服务器地址
     */
    public static final String URL_SERVER_ADDRESS_NORMAL_HTTPS = "http://172.16.60.232:7777/api";//正式服务器
    /**
     * 测试服务器地址
     */
    public static final String URL_SERVER_ADDRESS_TEST = "http://172.16.60.232:7777/api";//测试服务器
